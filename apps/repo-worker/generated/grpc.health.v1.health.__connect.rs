...
pub type OwnedHealthCheckRequestView = ::buffa::view::OwnedView<
    __buffa::view::HealthCheckRequestView<'static>,
>;
///Shorthand for `OwnedView<HealthCheckResponseView<'static>>`.
pub type OwnedHealthCheckResponseView = ::buffa::view::OwnedView<
    __buffa::view::HealthCheckResponseView<'static>,
>;
impl ::connectrpc::Encodable<HealthCheckResponse>
for __buffa::view::HealthCheckResponseView<'_> {
    fn encode(
        &self,
...
impl ::connectrpc::Encodable<HealthCheckResponse>
for ::buffa::view::OwnedView<__buffa::view::HealthCheckResponseView<'static>> {
    fn encode(
        &self,
        codec: ::connectrpc::CodecFormat,
    ) -> ::std::result::Result<::buffa::bytes::Bytes, ::connectrpc::ConnectError> {
...
pub trait Health: Send + Sync + 'static {
    ...
    fn check<'a>(
        ...
        request: ::connectrpc::ServiceRequest<'_, HealthCheckRequest>,
    ...
    fn watch(
        ...
        Output = ::connectrpc::ServiceResult<
            ::connectrpc::ServiceStream<
                impl ::connectrpc::Encodable<HealthCheckResponse> + Send + use<Self>,
            >,
        >,
    > + Send;
}
                ...
                "Check",
                {
                        ...
                        format|
                    {
                        ...
                        async move {
                            ...
                            svc.check(ctx, sreq)
                                .await?
                                .encode::<HealthCheckResponse>(format)
                        }
                    })
                },
            )
            ...
            "Check" => {
                ...
                Box::pin(async move {
                    ...
                    let req = ::connectrpc::ServiceRequest::<
                        HealthCheckRequest,
                    >::from_parts(&req, &body);
                    svc.check(ctx, req).await?.encode::<HealthCheckResponse>(format)
                })
            }
    ...
    <T::ResponseBody as ::connectrpc::http_body::Body>::Error: ::std::fmt::Display,
{
    ...
    pub async fn check(
        ...
        ::connectrpc::client::UnaryResponse<
            ::buffa::view::OwnedView<__buffa::view::HealthCheckResponseView<'static>>,
        >,
