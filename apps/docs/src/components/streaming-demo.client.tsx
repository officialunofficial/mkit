...
import { ChunkStrip, type StripChunk } from './chunk-strip.client'
import { ObjectRow } from './result-panel.client'
...
export function StreamingDemo() {
  ...
  return (
    ...
    // changing immediately, then scrolls down to the file controls. See `hash-demo.client.tsx` for the same pattern.
