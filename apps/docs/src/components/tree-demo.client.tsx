...
import { MerkleTree, type MerkleNode } from './merkle-tree.client'
import { HashChip, INPUT_CLASSES, ObjectRow, Section } from './result-panel.client'
...
export function TreeDemo() {
  ...
  return (
    // Mobile-first ordering: outputs above controls. See `hash-demo.client.tsx` for the same flex-col-reverse → lg:grid
    // pattern.
