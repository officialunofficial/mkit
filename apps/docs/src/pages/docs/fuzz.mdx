---
title: Fuzzing
description: "Conventions for the mkit-fuzz cargo-fuzz harnesses: targets, corpus layout, CI gates, and how to add new fuzz targets."
---
...
- [ ] Add the target body to `rust/fuzz/src/lib.rs` as
      `pub fn run_<name>(rng_seed: u64)` that enforces the six guardrails.
