---
title: "GHSA-002: trust roots scope"
description: "Advisory clarifying the scope of mkit's attestation trust roots and the precedence rules between user and repo configuration."
---
