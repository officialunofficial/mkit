---
title: "GHSA-003: key file handling"
description: "Advisory covering the on-disk permissions, atomic-write, and TOCTOU expectations for mkit signing key files."
---
...
- Spec: [Signing](/docs/spec/signing) §7 (Key file format)
