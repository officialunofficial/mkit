...
Status: **Informative**. Companion document to
[`SECURITY.md`](https://github.com/officialunofficial/mkit/blob/main/SECURITY.md)
and the [specifications](/docs/spec/objects). Audience: integrators,
auditors, and contributors changing crypto- or key-handling code.
