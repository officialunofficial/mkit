...
[`Transport`](https://github.com/officialunofficial/mkit/blob/main/rust/crates/mkit-core/src/protocol.rs) trait —
...
[RPC](/docs/spec/rpc). This document covers the transport-level
...
[`SshFrame`](https://github.com/officialunofficial/mkit/blob/main/rust/crates/mkit-rpc/proto/ssh.proto) per
[RPC §1](/docs/spec/rpc#1-wire-framing).
...
[RPC §1](/docs/spec/rpc#1-wire-framing)) bounds individual frame
...
[`BackoffIterator`](https://github.com/officialunofficial/mkit/blob/main/rust/crates/mkit-core/src/protocol.rs).
...
defined in [Packfile](/docs/spec/packfile). Transport implementations
...
within the v0.1.x line. See [RPC §2](/docs/spec/rpc#2-versioning)
