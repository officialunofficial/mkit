---
title: Install
description: "Install mkit from source, GitHub Releases, npm (WASM), or as a hardware-backed external signer, with verification steps for each channel."
---

# Install

mkit ships through four distribution channels. Pick a channel, follow
its steps, then verify the result.
...
[`rust/rust-toolchain.toml`](https://github.com/officialunofficial/mkit/blob/main/rust/rust-toolchain.toml). `rustup` will
...
[`rust/`](https://github.com/officialunofficial/mkit/tree/main/rust/). The publishable surface is in `rust/crates/`:
...
The [`release.yml`](https://github.com/officialunofficial/mkit/blob/main/.github/workflows/release.yml) workflow fires on
...
The `mkit-wasm` crate ([`rust/crates/mkit-wasm`](https://github.com/officialunofficial/mkit/tree/main/rust/crates/mkit-wasm))
...
[v1 stdio protocol](/docs/spec/external-signer). Wire one up with
...
See [`contrib/signers/mkit-sign-file`](https://github.com/officialunofficial/mkit/tree/main/contrib/signers/mkit-sign-file).
...
in [`contrib/signers/mkit-sign-se/README.md`](https://github.com/officialunofficial/mkit/blob/main/contrib/signers/mkit-sign-se/README.md).
...
[`contrib/signers/mkit-sign-tpm/README.md`](https://github.com/officialunofficial/mkit/blob/main/contrib/signers/mkit-sign-tpm/README.md).
...
See [`contrib/signers/mkit-sign-ctap`](https://github.com/officialunofficial/mkit/tree/main/contrib/signers/mkit-sign-ctap).
...
contract-tested in
[`.github/workflows/rust.yml`](https://github.com/officialunofficial/mkit/blob/main/.github/workflows/rust.yml) under the
...
[CLI reference](/docs/cli) or the
[attestation spec](/docs/spec/attestations).
