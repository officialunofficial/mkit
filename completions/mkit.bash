...
_mkit_complete() {
    ...
    local subcommands="init add rm hash cat tree commit log reflog status diff branch checkout tag config merge push pull fetch stash clone remote key keygen cherry-pick rebase bisect sparse-checkout serve blame verify attest verify-attest version help"
