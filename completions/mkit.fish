...
complete -c mkit -n "__fish_seen_subcommand_from workspace; and not __fish_seen_subcommand_from create status diff add log commit export push abandon" -a "create status diff add log commit export push abandon"
...
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from create" -l hosted -r -d "User-trusted hosted endpoint"
...
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from create" -l ref -r -d "Expected registered branch ref"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from create" -l workspace-id -r -d "Registered workspace ID"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from create" -l grant-id -r -d "Registered grant ID"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from create" -l grant-generation -r -d "Current grant generation"
...
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from commit" -s m -l message -r -d "Commit message"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from commit" -l author -r -d "Commit author identity"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from export" -l output -r -d "Exact pending-update output file"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from push" -l endpoint -r -d "mkit+file endpoint"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from push" -l repository -r -d "Recipient repository name"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from push" -l ref -r -d "Pinned refs/heads/ branch"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from abandon" -l candidate -r -d "Exact pending candidate ID"
complete -c mkit -n "__fish_seen_subcommand_from workspace; and __fish_seen_subcommand_from abandon" -l acknowledge-possible-publication -d "Acknowledge remote effect may have occurred"
