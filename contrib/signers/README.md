...
| [`mkit-sign-se/`](mkit-sign-se/README.md)     | **legacy** (Swift)      | Apple Secure Enclave, P-256 only. **Still on the pre-v1 line-JSON wire**; port to v1 protobuf is pending — until then it is NOT v1-conformant. |
