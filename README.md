...
| `mkit-git-bridge` | deterministic mkit↔git bridge (export mirroring; importer-signed import spec'd, landing in-series) ([`docs/SPEC-GIT-BRIDGE.md`](docs/SPEC-GIT-BRIDGE.md)) |
