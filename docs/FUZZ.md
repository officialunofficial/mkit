...
| `fuzz_targets/staged_update.rs` | borrowed MKWU v1 carrier/key and ordered inventory, with an unconditional committed-valid frame plus selected bounded valid diff/file and corrupt cursor/context/origin lanes |
