...
- [SPEC-SERVER-ACCESS](SPEC-SERVER-ACCESS.md) &mdash; optional service-local managed authority and role-gated data methods; grants and private partial workflows remain unavailable.
