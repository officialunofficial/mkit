...
commands:
  ...
  commit [-a] [-q] [--amend] [-m <msg> | -F <file>] [--author <spec>]
                    (-q suppresses the summary; -S/--gpg-sign and --no-verify
                    are accepted no-ops — mkit always signs and has no hooks)
  ...
  diff [--staged|--cached] [--name-only|--name-status|--stat] [--merge-base] [--exit-code|--quiet] [-z] [<rev> [<rev>] | <a>..<b> | <a>...<b>] [<path>...]
