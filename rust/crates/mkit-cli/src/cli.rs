...
commands:
  ...
  blame [--format=json] [-w] [-M] [-C] [--ignore-rev <rev>] [-L <start>,<end>] [<rev>] <file>
                    Show line-level commit attribution; -L limits to a line
                    range, -w ignores whitespace, -M/-C detect lines moved
                    within / copied from other files,
                    --ignore-rev/--ignore-revs-file skip noise commits, <rev>
                    blames as of a revision (default HEAD; JSONL with
                    --format=json)
