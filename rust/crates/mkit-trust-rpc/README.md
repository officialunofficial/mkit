...
schema-checked wire contract instead of an ad hoc TOML-only format —
...
(`.github/workflows/proto.yml`) — but this crate does not yet run
...
that implementation — and a future hosted trust-distribution endpoint
