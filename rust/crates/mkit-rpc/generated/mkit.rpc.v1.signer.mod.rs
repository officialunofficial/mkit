...
include!("mkit.rpc.v1.signer.signer.rs");
#[allow(
...
pub mod __buffa {
    ...
    pub mod view {
        #[allow(unused_imports)]
        use super::*;
        include!("mkit.rpc.v1.signer.signer.__view.rs");
        pub mod oneof {
            #[allow(unused_imports)]
            use super::*;
            include!("mkit.rpc.v1.signer.signer.__view_oneof.rs");
        }
    }
    pub mod oneof {
        #[allow(unused_imports)]
        use super::*;
        include!("mkit.rpc.v1.signer.signer.__oneof.rs");
    }
}
#[doc(inline)]
