...
/**
 * Mount gate + Suspense boundary for demos that read wasm via `use(mkit())`. SSR never evaluates the children — Waku's
...
function Fallback() {
  return <p className='microlabel text-muted'>Loading wasm…</p>
}
